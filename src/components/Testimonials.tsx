...
const COLORS = {
  ...
  border: '#e6e9ef'           // Subtle light border for minimal look
};
...
const Testimonials = () => {
  return (
    <section className="py-24 bg-white" style={{ background: COLORS.white }}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          <h2
            className="text-4xl font-bold mb-4"
            style={{ color: COLORS.black, letterSpacing: '-0.02em' }}
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {testimonials.map((testimonial, idx) => (
            <div
              key={idx}
              className="rounded-xl p-8 border flex flex-col h-full justify-between"
              style={{
            ...
            >
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h4 className="font-semibold text-base" style={{ color: COLORS.black }}>{testimonial.name}</h4>
                  <p className="text-xs" style={{ color: COLORS.primary }}>Age {testimonial.age}</p>
                </div>
              </div>
              ...
              <div className="relative mb-4 flex-1">
                ...
                />
                <p className="leading-relaxed text-sm" style={{ color: COLORS.grayText, paddingLeft: 32 }}>
                  {testimonial.text}
                </p>
              </div>
        ...
        <div className="text-center mt-20">
          ...
          >
            ...
            Get expert care for general diabetes and diabetic foot health from trusted specialists who put your well-being first.
            </p>
            <button
              onClick={() => {
