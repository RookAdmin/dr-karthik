...
import { Stethoscope, Droplet, Shield, Footprints } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Our <span className="text-[#22578c] relative">
              Services
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="sticky top-8 pt-0 lg:pt-16">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`
                          ...
                          ${service.activeColor.replace('bg-', 'from-')} to-transparent
                        `}></div>
            ...
            `}>
              <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
                ...
                <div className={`
                  ...
                  bg-gradient-to-br ${activeService.activeColor.replace('bg-', 'from-')} 
                ...
                <div className="p-8">
                  <h4 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                    <div className={`w-1 h-6 ${activeService.activeColor} rounded-full mr-3`}></div>
                    What We Offer
                  </h4>
                    ...
                    {activeService.items.map((item, idx) => (
                      <div
                        ...
                        style={{
                          ...
                          animation: isTransitioning ? 'none' : 'slideIn 0.5s ease-out forwards'
                        }}
                      >
                        <div className={`
