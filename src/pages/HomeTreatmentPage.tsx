...
const HomeTreatmentPage = () => {
  ...
  const serviceCards = [
    {
      ...
      description: "Comprehensive medical care at your doorstep",
      link: "general-services/general-healthcare",
    },
    {
      icon: Home,
      title: "Home Treatment",
      description: "Personalized medical care in the comfort of your home",
      link: "general-services/home-treatment",
    },
    {
      icon: Sun,
      title: "Skin Care",
      description: "Specialized skin treatments and consultations",
  ...
  const conditions = [
    {
      ...
      description:
        "Ongoing care and monitoring for patients with chronic conditions at home",
    },
    {
      icon: Stethoscope,
      title: "Post-Operative Care",
      description:
        "Professional medical support and recovery assistance after surgeries",
    },
    {
      icon: AlertTriangle,
      title: "Emergency Home Care",
      description:
        "Rapid medical response and treatment for urgent health situations",
    },
  ];

  const services = [
    "Comprehensive home health assessments",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Extensive expertise in home healthcare services",
    },
    {
      icon: Stethoscope,
      title: "Advanced Care",
      description:
        "State-of-the-art medical equipment and personalized treatment plans",
    },
    {
      icon: Heart,
      title: "Patient-Centered Approach",
      description:
        "Compassionate care tailored to individual patient needs and comfort",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-800 leading-tight mb-6">
                Comprehensive <span className="text-[#22578c]">Home</span>{" "}
                Treatment Services
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Professional medical care delivered directly to your doorstep.
                Personalized, compassionate, and convenient healthcare
                solutions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                >
                  ...
                  <span>Book Home Treatment Consultation</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Home Care Expertise</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="lg:w-1/2 lg:pl-12">
              <div className="relative">
                <div className="bg-white rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
                  <img
                    src="/home-treatment/banner.jpg"
                    alt="Home Treatment consultation"
      ...
      {/* Remaining sections follow the same pattern as other service pages */}
      {/* About Home Treatment Care */}
      <motion.section
        ref={aboutRef}
        initial="hidden"
        whileInView="visible"
      ...
      >
        {/* Similar structure to other pages, with content specific to Home Treatment */}
        <div className="container mx-auto px-4">
              ...
              <div className="space-y-8">
                <div>
                  <span className="bg-teal-50 text-[#22578c] text-sm font-semibold px-1 py-2 rounded-full">
                    Understanding Home Treatment Care
                  </span>
                </div>
                <h2 className="text-4xl font-bold text-gray-800 leading-tight">
                  A Holistic Approach to <br />
                  <span className="text-[#22578c]">Home Healthcare</span>
                </h2>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Home treatment services provide comprehensive medical care in
                  the comfort of your own home. Our skilled healthcare
                  professionals deliver personalized treatment, ensuring
                  continuity of care and patient comfort.
                </p>
                {/* Rest of the section follows similar pattern */}
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.section
        ...
        className="py-20"
      >
        {/* Similar to other pages, with conditions specific to Home Treatment */}
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Comprehensive home healthcare addressing various medical needs
              </p>
            </div>
      ...
      >
        {/* Similar to other pages, with services specific to Home Treatment */}
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">
                Our <span className="text-[#22578c]">Home Treatment</span>{" "}
                Services Include
              </h2>
              <p className="text-xl text-gray-600">
                Comprehensive care designed to support your health at home
              </p>
            </div>
      ...
      <motion.section
        ...
        className="py-20"
      >
        {/* Similar to other pages, with reasons specific to Home Treatment */}
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">
                Why Choose Our{" "}
                <span className="text-[#22578c]">Home Treatment</span> Care
              </h2>
              <p className="text-xl text-gray-600">
                Experience the difference of personalized, convenient healthcare
              </p>
            </div>
      ...
      >
        {/* Similar to other pages, with service cards */}
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
            ...
            <p className="text-xl text-[#4c5663] max-w-3xl mx-auto">
              Holistic care tailored to your unique healthcare needs
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2
              ...
              style={{ color: "#22578c" }}
            >
              Ready for Personalized Home Healthcare?
            </h2>
            <p
            ...
            >
              ...
              Let us support your health journey with compassionate,
...
export default HomeTreatmentPage;
